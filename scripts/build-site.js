...
// Flat <slug>.html rather than <slug>/index.html: Cloudflare Pages serves
// /concepts/transports straight from concepts/transports.html, so deployed URLs
// match the dev server exactly instead of picking up a trailing-slash redirect.
...
// The Functions cannot read builder/parts off disk, so freeze it into a module
// they can import. Keyed by the same relative paths compose() asks for.
const bundleParts = async () => {
	...
	const body = `// Generated by scripts/build-site.js. Do not edit.
